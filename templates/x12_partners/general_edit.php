...
<table width="400px" style="font-size:9pt;" CELLSPACING="0" CELLPADDING="3" border="0">
    ...
    <tr>
        ...
        <td COLSPAN="2" VALIGN="MIDDLE" >
           ...
           <?php foreach ($this->partner->get_idqual_array()  as $key => $value) 
                { 
    ...
    <tr>
        ...
        <td COLSPAN="2" VALIGN="MIDDLE" >
            ...
            <select name="x12_isa14">
                <?php foreach ($this->partner->get_x12_isa14_array()  as $key => $value) 
                { 
    ...
    <tr>
        ...
        <td COLSPAN="2" VALIGN="MIDDLE" >
            ...
            <select name="x12_isa15">
                <?php foreach ($this->partner->get_x12_isa15_array()  as $key => $value) 
                { 
    ...
    <tr>
        ...
        <td COLSPAN="2" VALIGN="MIDDLE" >
            ...
            <select name="x12_version">
                <?php foreach ($this->partner->get_x12_version_array()  as $key => $value) 
                { 
    ...
    <tr>
        ...
        <td COLSPAN="2" VALIGN="MIDDLE" >
            ...
            <select name="processing_format">
                <?php foreach ($this->partner->get_processing_format_array()  as $key => $value) 
                { 
