<?php /* Smarty version 2.6.29, created on 2017-03-17 01:16:24
         compiled from default/views/day/ajax_template.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'default/views/day/ajax_template.html', 10, false),array('function', 'pc_sort_events', 'default/views/day/ajax_template.html', 362, false),array('modifier', 'date_format', 'default/views/day/ajax_template.html', 357, false),array('modifier', 'string_format', 'default/views/day/ajax_template.html', 358, false),)), $this); ?>
        ...
        foreach ($times as $slottime) {
            ...
            foreach ($events as $e1) {
                ...
                if ($GLOBALS['display_canceled_appointments'] != 1){
                   if ($event['apptstatus'] == "x") { continue; }
                }
